 ...
 */
$errors['userNotFound'] = $errors['invalidPassword'] = "";
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  try {
    ...
    if ($result) {
      ...
      $errors['userNotFound'] = "No user found with the provided email.";
    }
  } catch (Exception $e) {
    ...
    <div class="container">
      <div class="registerContent d-flex justify-center item.center flex-col">
        <div class="innerContent ">
          ...
          <p class="roboto-light"><a href="./../ForgotPassword/ForgotPassword.php">Forgot password</a></p>
          <p class="roboto-light">Don't have an account? <a href="/">Register here</a></p>
        </div>
      </div>
    </div>
  </section>
